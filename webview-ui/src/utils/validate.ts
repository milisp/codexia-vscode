// Define types locally since shared modules are not available
...
type ModelInfo = any;
type Mode = string;
const openRouterDefaultModelId = "";

// Mock function since shared module is not available
const getModeSpecificFields = (...args: any[]): any => ({});
